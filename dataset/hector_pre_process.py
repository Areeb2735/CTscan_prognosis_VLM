...
def process_file(file_path):
    ...
    save_folder = "valid_preprocessed_hector_dummy/" #save folder for preprocessed
...
if __name__ == "__main__":
    split_to_preprocess = '/home/Mohammad.Qazi@mbzuai.ac.ae/dataset/hector/processed_samples' 
