...
loader = DataLoader(hect_dataset, batch_size=16, shuffle=False)
...
save_path = '/opt/sagemaker/new_home/Mohammad.Qazi@mbzuai.ac.ae/project/ct_rate/save/embeddings_only_spatial.npy'
